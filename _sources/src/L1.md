...
The work is based on [Fenton 2021](https://johndfenton.com/Lectures/Numerical-Methods/Numerical-Methods.pdf). We use units $k,g=1,1$. The first order periodic stream function is:

$$\psi(x,y)=-\bar Uy+B\frac{\sinh y}{\cosh d}\cos x$$

The frame is moving in the positive direction at speed $\bar U$. The depth of the water is $d$. The surface when $B=0$ is at $y=d$.
